...
jQuery(document).ready(function() {
   ...
   // Toggle Left Menu
   jQuery('.nav-bracket a').live('click', function() {

         var p = jQuery(this).parent();
         var sub = p.find('> ul');
         var ps = jQuery(this).parents('ul');

         // Dropdown works only when leftpanel is not collapsed

         if(!jQuery('body').hasClass('leftpanel-collapsed')) {
            jQuery('.nav-bracket li').removeClass('active');
            if(!p.hasClass('nav-parent')){
               p.addClass('active');
            }else {
   ...
   function adjustmainpanelheight() {
	  ...
	  var headHeight = jQuery(".headerbar").height();
	  var pageheadHeight = jQuery(".pageheader").outerHeight();
	  var winHeight = jQuery(window).height();
	  
/*      if(docHeight > jQuery('.mainpanel').height()){
		  
			jQuery('.mainpanel').height(docHeight-headHeight);
			 var mainHeight = jQuery('.mainpanel').height();
			 jQuery(".contentpanel").height(mainHeight-pageheadHeight);  
			 
		}*/
		jQuery('.mainpanel').height(winHeight);
		jQuery(".contentpanel").height(winHeight-headHeight-pageheadHeight);
