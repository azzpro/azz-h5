Module.define("system.jurisdiction", function(page, $) {
		...
		dataTable = $('#table').DataTable({
			...
			"ajax": function (data, callback, settings) {
				...
				//当前页码
				 $.ajax({
				 	type: "POST",   
				 	url: ulrTo + "/azz/api/client/permission/getRoleList",
				 	cache: false, //禁用缓存   
				 	data: param, //传入组装的参数   
				 	dataType: "json", 
	...
	function addRole() {
		...
		$.ajax({
			type: "POST",
			url: ulrTo+"/azz/api/client/permission/addRole",
			cache: false, //禁用缓存    
			dataType: "json", 
			data: {
	...
	page.editRole = function(roleCode) {
		...
		$.ajax({
			type: "POST",
			url: ulrTo+"/azz/api/client/permission/editRole",
			cache: false, //禁用缓存    
			dataType: "json", 
			data: {
				'roleCode':roleCode,
	...
	page.delDeptInfotoo = function(roleCode) {
		$.ajax({
			type: "POST",
			url: ulrTo+"/azz/api/client/permission/delRole",
			cache: false, //禁用缓存    
			dataType: "json", 
			data: {
				'roleCode': roleCode
