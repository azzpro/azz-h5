Module.define("system.department", function(page, $) {
	...
	function addDeptInfo() {
		...
		$.ajax({
			type: "POST",
			url: ulrTo+"/azz/api/client/dept/addFirstLevelDept",
			cache: false, //禁用缓存    
			dataType: "json", 
			data: {
	...
	function getDeptList() {
		$.ajax({
			type: "POST",
			url: ulrTo+"/azz/api/client/dept/searchClientDeptList",
			cache: false, //禁用缓存   
			async: false,
			dataType: "json", 
			data: {
	...
	page.getDeptParentList = function(deptCode) {
		...
		$.ajax({
			type: "POST",
			url: ulrTo+"/azz/api/client/dept/searchChildClientDeptList",
			cache: false, //禁用缓存    
			async: false,
			dataType: "json", 
			data: {
	...
	page.addChildDepttoo = function(deptCode) {
		...
		$.ajax({
			type: "POST",
			url: ulrTo+"/azz/api/client/dept/addChildDept",
			cache: false, //禁用缓存    
			dataType: "json", 
			data: {
	...
	page.editDeptInfotoo = function(deptCode) {
		...
		$.ajax({
			type: "POST",
			url: ulrTo+"/azz/api/client/dept/editDept",
			cache: false, //禁用缓存    
			dataType: "json", 
			data: {
	...
	page.statussWitch = function(deptCode,statusswitch) {
		if(statusswitch == '启用') {
			$.ajax({
				type: "GET",
				url: ulrTo+"/azz/api/client/dept/isEnableDept",
				cache: false, //禁用缓存    
				dataType: "json", 
				data: {
					'deptCode': deptCode,
	...
	page.delDeptInfotoo = function(deptCode) {
		$.ajax({
			type: "POST",
			url: ulrTo+"/azz/api/client/dept/delDept",
			cache: false, //禁用缓存    
			dataType: "json", 
			data: {
				'deptCode': deptCode
