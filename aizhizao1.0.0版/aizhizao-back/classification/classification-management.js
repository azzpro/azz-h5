Module.define("system.classification", function(page, $) {
				...
				if (data.code == 0) {
					...
					for(var i = 0;i<data.length;i++){
						...
						if(data[i].childList==null || !data[i].childList.length!=0){
							...
							+ "<span><a onclick=\"system.classification.editDeptInfo(\'" + assortmentCode + "','" + assortmentName + "\');\" href='javascript:;'>编辑</a>&nbsp;&nbsp;&nbsp;&nbsp;<a onclick=\"system.classification.delDeptInfo(\'" + assortmentCode + "','" + assortmentName + "\');\" href='javascript:;'>删除</a></span></li>"
							+ "</ul>";
						}else{
							var lii = "";
							for(var j = 0;j < data[i].childList.length;j++){
								...
								if(data[i].childList[j].childList==null || !data[i].childList[j].childList.length!=0){
									...
									+ "<span><a onclick=\"system.classification.editDeptInfo(\'" + assortmentCode2 + "','" + assortmentName2 + "\');\" href='javascript:;'>编辑</a>&nbsp;&nbsp;&nbsp;&nbsp;<a onclick=\"system.classification.delDeptInfo(\'" + assortmentCode2 + "','" + assortmentName2 + "\');\" href='javascript:;'>删除</a></span></li>"
									+ "</ul>";
								}else{
									var liii = "";
									for(var f = 0;f < data[i].childList[j].childList.length;f++){
										...
										+ "<span><a onclick=\"system.classification.editDeptInfo(\'" + assortmentCode3 + "','" + assortmentName3 + "\');\" href='javascript:;'>编辑</a>&nbsp;&nbsp;&nbsp;&nbsp;<a onclick=\"system.classification.delDeptInfo(\'" + assortmentCode3 + "','" + assortmentName3 + "\');\" href='javascript:;'>删除</a></span></li>"
										+ "</ul>";
									}
	...
	page.editDeptInfo = function(assortmentCode,assortmentName) {
		...
		$('#myModal2').modal('show');
		$('#editconfirm').attr("onclick", "system.classification.editDeptInfotoo(\'" + assortmentCode + "\');")
	}
	...
	page.delDeptInfo = function(assortmentCode,assortmentName) {
		...
		$('#deletebunnot').attr("onclick", "system.classification.delDeptInfotoo(\'" + assortmentCode + "\');")
	}
